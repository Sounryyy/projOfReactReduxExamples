...
// Хуки нельзя использовать в условиях и циклах
// Можно вызывать только в React компонентах или в собственных хуках
// Хуками нельзя пользоваться в функциях, которые не являются react компонентами
